...
class AppClient {
  ...
  public async getAllCoinPrices(currency: SupportedCurrencies, perPage = 100, page = 1) {
  ...
  public async getCoinChartData(id: string, currency: SupportedCurrencies, days: TimePeriod) {
  ...
  public async fetchFavourites(ids: string[], currency: SupportedCurrencies) {
